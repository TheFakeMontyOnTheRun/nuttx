...
.. Note: (2014-12-12) I was unsuccessful getting my AT24 module to work on the TM4C123G
...
.. Note: Arguments are "sticky".  For example, once the I2C address is
   specified, that address will be reused until it is changed.

.. Note: The I2C dev command may have bad side effects on your I2C devices.
